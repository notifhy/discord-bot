...
async function information(interaction: CommandInteraction) {
  const informationEmbed = commandEmbed({ color: '#7289DA', footer: interaction })
...
async function specificCommand(interaction: CommandInteraction) {
  ...
  const commandSearchEmbed = commandEmbed({ color: '#7289DA', footer: interaction });
...
async function commands(interaction: CommandInteraction) {
  ...
  const allCommandsEmbed = commandEmbed({ color: '#7289DA', footer: interaction })
    .setTitle('Commands')
